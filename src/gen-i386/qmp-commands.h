...
void qmp_blockdev_change_medium(const char *device, const char *filename, bool has_format, const char *format, bool has_read_only_mode, BlockdevChangeReadOnlyMode read_only_mode, Error **errp);
...
void qmp_blockdev_open_tray(const char *device, bool has_force, bool force, Error **errp);
...
void qmp_drive_backup(const char *device, const char *target, bool has_format, const char *format, MirrorSyncMode sync, bool has_mode, NewImageMode mode, bool has_speed, int64_t speed, bool has_bitmap, const char *bitmap, bool has_on_source_error, BlockdevOnError on_source_error, bool has_on_target_error, BlockdevOnError on_target_error, Error **errp);
...
void qmp_x_blockdev_del(bool has_id, const char *id, bool has_node_name, const char *node_name, Error **errp);
void qmp_marshal_x_blockdev_del(QDict *args, QObject **ret, Error **errp);
void qmp_x_blockdev_insert_medium(const char *device, const char *node_name, Error **errp);
