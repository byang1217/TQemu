...
typedef enum ImageInfoSpecificKind {
    ...
    IMAGE_INFO_SPECIFIC_KIND__MAX = 2,
...
typedef enum QCryptoHashAlgorithm {
    ...
    QCRYPTO_HASH_ALG_SHA256 = 2,
    QCRYPTO_HASH_ALG__MAX = 3,
...
typedef struct q_obj_NetdevHubPortOptions_wrapper q_obj_NetdevHubPortOptions_wrapper;
...
typedef struct q_obj_block_set_io_throttle_arg q_obj_block_set_io_throttle_arg;

typedef struct q_obj_blockdev_add_arg q_obj_blockdev_add_arg;
...
typedef struct q_obj_drive_mirror_arg q_obj_drive_mirror_arg;
...
typedef struct q_obj_migrate_set_parameters_arg q_obj_migrate_set_parameters_arg;
...
struct q_obj_NetdevHubPortOptions_wrapper {
    NetdevHubPortOptions *data;
};
...
struct q_obj_block_set_io_throttle_arg {
    char *device;
    int64_t bps;
    int64_t bps_rd;
    int64_t bps_wr;
...
struct q_obj_migrate_set_parameters_arg {
